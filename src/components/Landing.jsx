...
function Landing() {
    return (
        <section id='AboutMe' className='h-[calc(100vh-5rem)] mt-20 scroll-mt-20 flex flex-col gap-4 justify-center items-center px-4 md:px-2 snap-start -z-10'>
            <section className="">
            ...
            <section className='flex flex-row gap-4 items-start justify-center'>
                <picture className="overflow-clip shrink-0">
                    <img src={picture} className='h-48 w-40 profile border-4 object-cover object-bottom' />
                </picture>
